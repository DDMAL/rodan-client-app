...
///////////////////////////////////////////////////////////////////////////////////////
    ...
    _initializeRadio()
    {
        rodan.rodan_client_core.channel.on(rodan.rodan_client_core.events.EVENT__WORKFLOWRUN_CREATED, options => this._handleEventWorkflowRunStartResponse(options));
        rodan.rodan_client_core.channel.on(rodan.rodan_client_core.events.EVENT__WORKFLOWRUN_DELETED, options => this._handleEventWorkflowRunDeleteResponse(options));
        rodan.rodan_client_core.channel.on(rodan.rodan_client_core.events.EVENT__WORKFLOWRUN_STARTED, options => this._handleEventWorkflowRunStartResponse(options));
...
///////////////////////////////////////////////////////////////////////////////////////
    ...
    _handleEventItemSelected(options)
    {
        ...
        var runJobs = rodan.rodan_client_core.channel.request(rodan.rodan_client_core.events.REQUEST__RUNJOBS_LOAD, {data: {workflow_run: options.workflowrun.id}});
        var resources = rodan.rodan_client_core.channel.request(rodan.rodan_client_core.events.REQUEST__RESOURCES_LOAD, {data: {result_of_workflow_run: options.workflowrun.id}});
        Radio.channel('rodan').request(rodan.rodan_client_core.events.REQUEST__UPDATER_SET_COLLECTIONS, {collections: [runJobs, resources]});
