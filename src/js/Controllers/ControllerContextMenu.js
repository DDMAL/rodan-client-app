...
///////////////////////////////////////////////////////////////////////////////////////
    ...
    _initializeRadio()
    {
        Radio.channel('rodan').reply(Events.REQUEST__CONTEXTMENU_HIDE, () => this._handleRequestContextMenuHide());
        Radio.channel('rodan').reply(Events.REQUEST__CONTEXTMENU_SHOW, options => this._handleRequestContextMenuShow(options));
    }
    ...
    _handleRequestContextMenuShow(options)
    {
        ...
        for (var index in options.items)
        {
            ...
            var functionCall = (event) => {
                ...
                Radio.channel('rodan').request(Events.REQUEST__CONTEXTMENU_HIDE);
